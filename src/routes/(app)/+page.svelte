...
<section>
  ...
  <ItemRevealContainer>
    ...
    <ItemReveal title="How do I report a bug?">
      <p>
        Submit your issue on Github using the issue tracker: <br /> <br />
        You'll find the related repositories down below at the footer. <br /> <br />
        
        if it's an issue with converting then: <br />
      </p>
      
      <ul>
        <il>Open settings and enable debug <br /> </il>
        <il>Open the console (ctrl + shift + i) to see the debug logs <br /> </il>
      </ul>
      
      <p>
        then reconvert your map or skin and copy the output and include it in your issue submission.
      </p>
    </ItemReveal>
    ...
    <ItemReveal title="How do I request a feature?">
      <p>
        That's great! Go to Github and open an issue. <br /> <br />
        You'll find the related repositories down below at the footer. <br />
      </p>
    </ItemReveal>
    
    <ItemReveal title="I can't find my question here.">
      <p>
      You can go on Github and open an issue. <br /> <br />
      You'll find the related repositories down below at the footer. <br /> <br />
      or ask me directly: <br />
      
        <svg width="16" height="16" viewBox="0 0 24 24" fill="#FFFFFF" style="display: inline; vertical-align: middle; margin-right: 4px;">
        ...
        <a rel="noopener" target="_blank" href="https://discord.com/users/695720659988250765">@_theguy2</a> <br />
        ...
        <a rel="noopener" target="_blank" href="https://github.com/menvae">@menvae</a> <br />
      </p>
    </ItemReveal>
