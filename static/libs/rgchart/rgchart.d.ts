...
export class ChartInfo {
  private constructor();
  free(): void;
  static new(difficulty_name: string, hp: number, od: number, bg_path: string, video_path: string, song_path: string, audio_offset: number, preview_time: number, key_count: number, bpm_affects_sv: boolean): ChartInfo;
...
export class Key {
  ...
  static mine(value?: number | null): Key;
  static fake(): Key;
  static tick(): Key;
  static unknown(): Key;
...
export interface InitOutput {
  ...
  readonly key_mine: (a: number) => number;
  readonly key_fake: () => number;
  readonly key_tick: () => number;
  ...
  readonly __wbg_get_chartinfo_bpm_affects_sv: (a: number) => number;
  readonly __wbg_set_chartinfo_bpm_affects_sv: (a: number, b: number) => void;
  readonly chartinfo_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => number;
